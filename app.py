...
# Track attempts and dynamic easy-mode thresholds per channel (start at 30, then +20 after a real code is given)
CHANNEL_STATE = defaultdict(lambda: {"attempts": 0, "interval": 20, "next_threshold": 20})
